package.path = package.path .. ";" .. os.getenv("HOME") .. "/.config/awesome/inferno/?.lua"
package.path = package.path .. ";" .. os.getenv("HOME") .. "/.config/awesome/inferno/plugins/?.lua"
...
gears = Core.Module("gears")
awful = Core.Module("awful")
awful.rules = Core.Module("awful.rules")
Core.Module("awful.autofocus")
-- Widget and layout library
wibox = Core.Module("wibox")
...
-- Left bar
Core.Plugin("Prompt")
Core.Plugin("Menu.Launcher")
Core.Plugin("Tags.TagBox")
...
root.buttons(awful.util.table.join(
    awful.button({ }, 3, function () app_menu.main_menu:toggle() end),
